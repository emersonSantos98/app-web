...
async function onResend() {
  securityService.securityStore.formSecurityForgotPassword.email = userData.email
  securityService.securityStore.formSecurityForgotPassword.type = 'verifyEmail'
...
async function onSubmit (newValue) {
  ...
  securityService.securityStore.formSecurityValidCode.user_id = userData.id
  securityService.securityStore.formSecurityValidCode.type = 'two_factor'
  await securityService.postSecurityValidCode()
  await authService.codeValid()
    ...
    >
      ...
      >
        <VCardText>
          ...
          <p class="mb-2">
            We sent a confirmation code to your email. Enter the code from the email in the field below.
          </p>
